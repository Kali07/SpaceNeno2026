    ...
    <div className="flex flex-col h-full">
      <div className="px-6 py-5 flex items-center justify-between">
        <div className="flex items-center gap-2.5">
          ...
          <span className="text-lg font-bold tracking-tight font-heading text-[#333333]">
            NENO SPACE
          </span>
        </div>
      ...
      <div className="px-4 py-4">
        <div className="rounded-lg bg-[#0066CC]/5 p-3">
          ...
          <p className="text-xs text-[#666666] mt-1">
            Gestion de 16 membres dans 9 stations
          </p>
        </div>
      </div>
    </div>
...
export default function DashboardLayout() {
  ...
  return (
    <div className="min-h-screen flex bg-[#F5F5F5]">
      ...
      {/* Desktop Sidebar */}
      <aside
        className="hidden lg:flex lg:w-64 lg:flex-col bg-white border-r border-gray-200 fixed inset-y-0 left-0 z-40"
      ...
      {sidebarOpen && (
        <div className="fixed inset-0 z-50 lg:hidden">
          ...
          <aside
            className="fixed inset-y-0 left-0 w-72 bg-white shadow-xl z-50"
      ...
      <div className="flex-1 lg:pl-64 flex flex-col min-h-screen">
        ...
        {/* Header */}
        <header
          className="bg-white/90 backdrop-blur-md border-b border-gray-200 sticky top-0 z-30 px-4 md:px-6 lg:px-8"
